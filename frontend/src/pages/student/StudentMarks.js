...
const StudentMarks = () => {
  ...
  useEffect(() => {
    getStudentMarks(user.register_number)
                ...
                <tbody>
                  {entries.map((e) => (
                    <tr key={e.id} style={styles.tr}>
                      ...
                      <td style={styles.td}>
                        <span style={{ color: (e.marks_obtained / e.exam_max_marks) * 100 >= 50 ? '#4caf50' : '#f44336', fontWeight: '600' }}>
                          {((e.marks_obtained / e.exam_max_marks) * 100).toFixed(1)}%
                        </span>
                      </td>
                    </tr>
                  ))}
